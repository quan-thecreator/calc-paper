...
\qs{}{
	...
	\begin{turn}{180}
	{
	\textbf{Answer.} Use Ratio Test test to identify that $R=1$ and interval of convergence to be $[0,2]$
	}
	\end{turn}
}
\qs{}{
	Find if $$\sum_{n=1}^{\infty}{\frac{5+2n}{n^2}}$$ converges or diverges. \newline
	\begin{turn}{180}
	{
	\textbf{Answer.} Use Limit Comparison Test with $b_n=\tfrac{1}{n}$ to identify that the series converges.
	}
	\end{turn}
}
\qs{}{
	Use the Direct Comparison Test to see if $\sum_{n=1}^{\infty}{\frac{5+2n}{n^2}}$ converges.\newline
	\begin{turn}{180}
	{
	\textbf{Answer.} Converges. Use $b_n=\frac{c}{n}$ where $c\ge 1$
	}
	\end{turn}
}
\qs{}{
	Consider the Series $$\sum_{n=1}^{\infty}{(-1)^{n+1}a_n}$$ where $a_n>\tfrac{1}{n}$ for all n and $a_n$ decreases for all $n$ to $0$. Which of the following are true? \newline
	...
	\begin{turn}{180}
	{
	\textbf{Answer.} B, alternating series test $\to$ series converges, but using the Direct Comparison $\to$ $a_n$ diverges.
	}
	\end{turn}

}
\qs{}{
	Show that $$\sum_{n=1}^{\infty}{\frac{(-1)^{n+1}}{\sqrt{n}}}$$ either converges absolutely, converges conditionally, or diverges. Specify the test used.
	\begin{turn}{180}
	{
	\textbf{Answer.} converges conditionally, Alternating Series test & p-series.
	}
	\end{turn}
}
\qs{}{
	Show that $$\sum_{n=1}^{\infty}{\frac{(-1)^n}{n}}$$ either converges absolutely, converges conditionally, or diverges. Specify the test used.
	\begin{turn}{180}
	{
	\textbf{Answer.} converges conditionally, Alternating Series test & p-series.
	}
...
\qs{}{
	Show that $$\sum_{n=2}^{\infty}{\frac{1}{n\ln{(n)}}}$$ either converges absolutely, converges conditionally, or diverges. Specify the test used.
	\begin{turn}{180}
	{
	\textbf{Answer.} Diverges by integral test.
	}
	\end{turn}
}
\qs{}{
	Show that $$\sum_{n=1}^{\infty}{\frac{\cos{n}}{n^2+1}}$$ either converges absolutely, converges conditionally, or diverges. Specify the test used.
	\begin{turn}{180}
	{
	\textbf{Answer.} converges absolutely, Alternating Series test & Direct Comparison
	}
	\end{turn}
}
\qs{}{
	Show that $$\sum_{n=1}^{\infty}{\frac{(-1)^nn}{n^2+1}}$$ either converges absolutely, converges conditionally, or diverges. Specify the test used.
	\begin{turn}{180}
	{
	\textbf{Answer.} Diverges by Direct Comparison
	}
	\end{turn}
}
\qs{}{
	Find the Alternating Error Bound of$$\sum_{n=3}^{\infty}{\frac{(-1)^{n+1}n}{2^n}}$$ with a partial sum consisting of 3 non-zero terms.
	\begin{turn}{180}
	{
	\textbf{Answer.} $3/32$
	}
...
\qs{}{
	Show that $$\sum_{n=1}^{\infty}{\frac{\ln{n}}{n^2}}$$ either converges absolutely, converges conditionally, or diverges. Specify the test used.
	\begin{turn}{180}
	{
	\textbf{Answer.} converges absolutely by direct comparison
	}
	\end{turn}
}
\end{document}
